(function ($) {
    ...
    $(window).scroll(function () {
        var sticky = $('.change_color'),
            scroll = $(window).scrollTop();
        if (scroll >= 100) sticky.addClass('has-submenu');
        else sticky.removeClass('has-submenu');
    });
    $(window).scroll(function () {
        var sticky = $('.line'),
            scroll = $(window).scrollTop();
        if (scroll >= 100) sticky.addClass('change_line');
        else sticky.removeClass('change_line');
    });
    $(window).scroll(function () {
        var sticky = $('.header-login'),
            scroll = $(window).scrollTop();
        if (scroll >= 100) sticky.addClass('color');
        else sticky.removeClass('color');
    });
    // $(window).scroll(function () {
    //     var logo = $('.logo'),
    //         scroll = $(window).scrollTop();
    //     if (scroll >= 100) logo.attr('src' ,'assets/img/logo1.png' );
    //     else logo.attr('src','assets/img/logo2.png' );
    // });
